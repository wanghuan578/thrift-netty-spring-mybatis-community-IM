...
public class ClientLoginRes implements org.apache.thrift.TBase<ClientLoginRes, ClientLoginRes._Fields>, java.io.Serializable, Cloneable, Comparable<ClientLoginRes> {
  ...
  public String user_info; // required
  public String session_ticket; // required
  ...
  public ClientLoginRes setError_text(String error_text) {
    this.error_text = error_text;
    return this;
  }
  ...
  public ClientLoginRes setUser_info(String user_info) {
    this.user_info = user_info;
    return this;
  }
  ...
  public String getSession_ticket() {
    return this.session_ticket;
  }

  public ClientLoginRes setSession_ticket(String session_ticket) {
    this.session_ticket = session_ticket;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SESSION_TICKET:
      if (value == null) {
        ...
        setSession_ticket((String)value);
      }
      break;
  ...
  public int compareTo(ClientLoginRes other) {
    ...
    lastComparison = Boolean.valueOf(isSetSession_ticket()).compareTo(other.isSetSession_ticket());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSession_ticket()) {
    ...
    lastComparison = Boolean.valueOf(isSetRoom_gate_info()).compareTo(other.isSetRoom_gate_info());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRoom_gate_info()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ClientLoginRes(");
    boolean first = true;
