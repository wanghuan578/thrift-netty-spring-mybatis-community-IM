...
public class ServiceListChangeRes implements org.apache.thrift.TBase<ServiceListChangeRes, ServiceListChangeRes._Fields>, java.io.Serializable, Cloneable, Comparable<ServiceListChangeRes> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ServiceListChangeRes");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new ServiceListChangeResStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new ServiceListChangeResTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ServiceListChangeRes.class, metaDataMap);
  }

  public ServiceListChangeRes() {
  }
   ...
   */
  public ServiceListChangeRes(ServiceListChangeRes other) {
  ...
  public ServiceListChangeRes deepCopy() {
    return new ServiceListChangeRes(this);
  }
  ...
  public ServiceListChangeRes setError_code(long error_code) {
    this.error_code = error_code;
    setError_codeIsSet(true);
    return this;
  }
  ...
  public ServiceListChangeRes setError_text(String error_text) {
    this.error_text = error_text;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ServiceListChangeRes)
      return this.equals((ServiceListChangeRes)that);
    return false;
  }

  public boolean equals(ServiceListChangeRes that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(ServiceListChangeRes other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ServiceListChangeRes(");
    boolean first = true;
  ...
  private static class ServiceListChangeResStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ServiceListChangeResStandardScheme getScheme() {
      return new ServiceListChangeResStandardScheme();
    }
  }

  private static class ServiceListChangeResStandardScheme extends org.apache.thrift.scheme.StandardScheme<ServiceListChangeRes> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ServiceListChangeRes struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ServiceListChangeRes struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ServiceListChangeResTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ServiceListChangeResTupleScheme getScheme() {
      return new ServiceListChangeResTupleScheme();
    }
  }

  private static class ServiceListChangeResTupleScheme extends org.apache.thrift.scheme.TupleScheme<ServiceListChangeRes> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ServiceListChangeRes struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ServiceListChangeRes struct) throws org.apache.thrift.TException {
