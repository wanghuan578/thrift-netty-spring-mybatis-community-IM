...
public class SessionTicket implements org.apache.thrift.TBase<SessionTicket, SessionTicket._Fields>, java.io.Serializable, Cloneable, Comparable<SessionTicket> {
  ...
  public String nick_name; // required
  public String client_ip; // required
  public String client_mac; // required
  public String client_version; // required
  public int app_id; // required
  public String session_id; // required
  public String session_key; // required
  ...
  public SessionTicket setUser_name(String user_name) {
    this.user_name = user_name;
    return this;
  }
  ...
  public SessionTicket setEmail(String email) {
    this.email = email;
    return this;
  }
  ...
  public SessionTicket setNick_name(String nick_name) {
    this.nick_name = nick_name;
    return this;
  }
  ...
  public SessionTicket setClient_ip(String client_ip) {
    this.client_ip = client_ip;
    return this;
  }
  ...
  public SessionTicket setClient_mac(String client_mac) {
    this.client_mac = client_mac;
    return this;
  }
  ...
  public SessionTicket setClient_version(String client_version) {
    this.client_version = client_version;
    return this;
  }
  ...
  public SessionTicket setSession_id(String session_id) {
    this.session_id = session_id;
    return this;
  }
  ...
  public SessionTicket setSession_key(String session_key) {
    this.session_key = session_key;
    return this;
  }
  ...
  public int compareTo(SessionTicket other) {
    ...
    lastComparison = Boolean.valueOf(isSetNick_name()).compareTo(other.isSetNick_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNick_name()) {
    ...
    lastComparison = Boolean.valueOf(isSetClient_mac()).compareTo(other.isSetClient_mac());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetClient_mac()) {
    ...
    lastComparison = Boolean.valueOf(isSetSession_key()).compareTo(other.isSetSession_key());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSession_key()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SessionTicket(");
    boolean first = true;
