...
public class HelloNotify implements org.apache.thrift.TBase<HelloNotify, HelloNotify._Fields>, java.io.Serializable, Cloneable, Comparable<HelloNotify> {
  ...
  public HelloNotify setError_text(String error_text) {
    this.error_text = error_text;
    return this;
  }
  ...
  public HelloNotify setService_name(String service_name) {
    this.service_name = service_name;
    return this;
  }
  ...
  public int compareTo(HelloNotify other) {
    ...
    lastComparison = Boolean.valueOf(isSetServer_time()).compareTo(other.isSetServer_time());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetServer_time()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HelloNotify(");
    boolean first = true;
