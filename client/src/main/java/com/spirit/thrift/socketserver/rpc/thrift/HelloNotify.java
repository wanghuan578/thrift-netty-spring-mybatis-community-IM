...
public class HelloNotify implements org.apache.thrift.TBase<HelloNotify, HelloNotify._Fields>, java.io.Serializable, Cloneable, Comparable<HelloNotify> {
  ...
  public HelloNotify setError_text(@org.apache.thrift.annotation.Nullable java.lang.String error_text) {
    this.error_text = error_text;
    return this;
  }
  ...
  public HelloNotify setService_name(@org.apache.thrift.annotation.Nullable java.lang.String service_name) {
    this.service_name = service_name;
    return this;
  }
