...
public class KeepAliveRes implements org.apache.thrift.TBase<KeepAliveRes, KeepAliveRes._Fields>, java.io.Serializable, Cloneable, Comparable<KeepAliveRes> {
  ...
  private static final org.apache.thrift.protocol.TField CURRENT_TIMESTAMP_REQ_FIELD_DESC = new org.apache.thrift.protocol.TField("current_timestamp_req", org.apache.thrift.protocol.TType.I64, (short)4);
  private static final org.apache.thrift.protocol.TField CURRENT_TIMESTAMP_RES_FIELD_DESC = new org.apache.thrift.protocol.TField("current_timestamp_res", org.apache.thrift.protocol.TType.I64, (short)5);
  ...
  public long current_timestamp_res; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    ID((short)3, "id"),
    CURRENT_TIMESTAMP_REQ((short)4, "current_timestamp_req"),
    CURRENT_TIMESTAMP_RES((short)5, "current_timestamp_res");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 3: // ID
          return ID;
        case 4: // CURRENT_TIMESTAMP_REQ
          return CURRENT_TIMESTAMP_REQ;
        case 5: // CURRENT_TIMESTAMP_RES
          return CURRENT_TIMESTAMP_RES;
        default:
          return null;
      }
    }
  ...
  private static final int __CURRENT_TIMESTAMP_REQ_ISSET_ID = 2;
  private static final int __CURRENT_TIMESTAMP_RES_ISSET_ID = 3;
  ...
  static {
    ...
    tmpMap.put(_Fields.CURRENT_TIMESTAMP_RES, new org.apache.thrift.meta_data.FieldMetaData("current_timestamp_res", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    ...
    long current_timestamp_res)
  {
    ...
    this.current_timestamp_res = current_timestamp_res;
    setCurrent_timestamp_resIsSet(true);
  }
  ...
  public KeepAliveRes(KeepAliveRes other) {
    ...
    this.current_timestamp_res = other.current_timestamp_res;
  }
  ...
  public void clear() {
    ...
    setCurrent_timestamp_resIsSet(false);
    this.current_timestamp_res = 0;
  }
  ...
  public KeepAliveRes setError_text(String error_text) {
    this.error_text = error_text;
    return this;
  }
  ...
  public KeepAliveRes setCurrent_timestamp_req(long current_timestamp_req) {
    this.current_timestamp_req = current_timestamp_req;
    setCurrent_timestamp_reqIsSet(true);
    return this;
  }
  ...
  public long getCurrent_timestamp_res() {
    return this.current_timestamp_res;
  }

  public KeepAliveRes setCurrent_timestamp_res(long current_timestamp_res) {
    this.current_timestamp_res = current_timestamp_res;
    setCurrent_timestamp_resIsSet(true);
    return this;
  }

  public void unsetCurrent_timestamp_res() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __CURRENT_TIMESTAMP_RES_ISSET_ID);
  }

  /** Returns true if field current_timestamp_res is set (has been assigned a value) and false otherwise */
  public boolean isSetCurrent_timestamp_res() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __CURRENT_TIMESTAMP_RES_ISSET_ID);
  }

  public void setCurrent_timestamp_resIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __CURRENT_TIMESTAMP_RES_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CURRENT_TIMESTAMP_RES:
      if (value == null) {
        unsetCurrent_timestamp_res();
      } else {
        setCurrent_timestamp_res((Long)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case CURRENT_TIMESTAMP_RES:
      return getCurrent_timestamp_res();
  ...
  public boolean isSet(_Fields field) {
    ...
    case CURRENT_TIMESTAMP_RES:
      return isSetCurrent_timestamp_res();
    }
    throw new IllegalStateException();
  }
  ...
  public boolean equals(KeepAliveRes that) {
    ...
    boolean this_present_current_timestamp_res = true;
    boolean that_present_current_timestamp_res = true;
    if (this_present_current_timestamp_res || that_present_current_timestamp_res) {
      if (!(this_present_current_timestamp_res && that_present_current_timestamp_res))
        return false;
      if (this.current_timestamp_res != that.current_timestamp_res)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(current_timestamp_res);
  ...
  public int compareTo(KeepAliveRes other) {
    ...
    lastComparison = Boolean.valueOf(isSetCurrent_timestamp_res()).compareTo(other.isSetCurrent_timestamp_res());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCurrent_timestamp_res()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.current_timestamp_res, other.current_timestamp_res);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("KeepAliveRes(");
    boolean first = true;
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("current_timestamp_res:");
    sb.append(this.current_timestamp_res);
    first = false;
    sb.append(")");
    return sb.toString();
  }
  ...
  private static class KeepAliveResStandardScheme extends org.apache.thrift.scheme.StandardScheme<KeepAliveRes> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, KeepAliveRes struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 5: // CURRENT_TIMESTAMP_RES
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.current_timestamp_res = iprot.readI64();
              struct.setCurrent_timestamp_resIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, KeepAliveRes struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(CURRENT_TIMESTAMP_RES_FIELD_DESC);
      oprot.writeI64(struct.current_timestamp_res);
      oprot.writeFieldEnd();
  ...
  private static class KeepAliveResTupleScheme extends org.apache.thrift.scheme.TupleScheme<KeepAliveRes> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, KeepAliveRes struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetCurrent_timestamp_res()) {
        optionals.set(4);
      }
